...
class role(commands.Cog):
    ...
    async def on_ready(self):
        print('Zabiv MAFIA State by jokos - Запущен')
    ...
    async def on_message(self, ctx):
        ...
        if ctx.channel.id == 822954411964760094:
            ...
            if z in nick_registr:
                ...
                channel = self.client.get_channel(823231630944632835)
    ...
    async def on_raw_reaction_add(self, payload): 
        chal = [823231630944632835]

        chakfd = self.client.get_channel(822905365821259776)
